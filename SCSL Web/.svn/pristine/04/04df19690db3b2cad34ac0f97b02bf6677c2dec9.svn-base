...
public class ImageEncoder {
	...
	public String createImgFromFile(String path, String areaName) {
		...
		String filePath = ResourceBundle.getBundle("spring/app").getString("filepath.pdsa")+File.separator+
				ResourceBundle.getBundle("messages/messages").getString(Constants.Web.SCSL_CHART_FOLDER_NAME)+File.separator;
