...
function checkSessionOut(data){
  ...
  function allServices($http, $q) {
	...
	this.getPDSAChartForFacility = function(facilityId){
		var deferred = $q.defer();
        // get posts from database
	...
	this.getAreaForFacilityViewFilterData = function(){
		var deferred = $q.defer();
		$http.get("getAreaForReportFilterData?viewName=facilityView")
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
            deferred.resolve(jsonData);
	 ...
	 * Dashboard Section
	*/
	this.getDashboardChart = function(){
		var deferred = $q.defer();
		$http.get("resources/json/landingdashboardchart.json")
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
            deferred.resolve(jsonData);
	...
	this.getDashboardIndicators = function(){
		var deferred = $q.defer();
		$http.get("resources/json/landingdashboardgrid.json")
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
            deferred.resolve(jsonData);
	...
	this.getRestDashboardIndicators = function(){
		var deferred = $q.defer();
		$http.get("getAllLandingBoxValue")
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
            deferred.resolve(jsonData);
	...
	this.getTrendData = function(facilityId){
		var deferred = $q.defer();
        // get posts from database

			var url = 'getLineChartOfEngagementScore?facilityId=' + facilityId ;
		$http.post(url)
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
	...
	this.getPDSASummaryChart = function(pdsaId){
		var deferred = $q.defer();
        // get posts from database

			var url = 'getPDSASummaryChart?pdsaId=' + pdsaId ;
		$http.post(url)
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
	...
	this.getFacilityChart = function(areaId, hasLR){
		var deferred = $q.defer();
        // get posts from database

			var url = 'facilityChart?areaId=' + areaId +"&hasLR="+hasLR;
		$http.get(url)
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
	...
	this.getAllIndicatorDetails = function(){
		var deferred = $q.defer();
        // get posts from database

			var url = 'getAllIndicatorDetails';
		$http.get(url)
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
	...
	this.getIndicatorChart = function(indicatorId, stateId, districtId, facilityTypeId, facilitySizeId, waveParam, periodicity, indType){
		var deferred = $q.defer();
        // get posts from database

			var url = 'indicatorChart?indicatorId=' + indicatorId;;
			if(stateId){
			...
			if(facilityTypeId){
				url = url + '&facilityTypeId=' + facilityTypeId;
			}
			if(facilitySizeId){
				url = url + '&facilitySizeId=' + facilitySizeId;
			}
			if(waveParam){
				url = url + '&waveParam=' + waveParam;
			}
			if(indType){
				url = url + '&indType=' + indType;
			}
			url = url + '&periodicity=' + periodicity;
		$http.get(url)
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
	...
	this.getRelatedIndicators = function(indicatorId){
		var deferred = $q.defer();
        // get posts from database

			var url = 'relatedIndicators?indicatorId=' + indicatorId;
		$http.get(url)
          .then(function(result) {
        	  checkSessionOut(result.data);
        	  jsonData = result.data;
