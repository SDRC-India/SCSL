			...
			<div class="select-container dist-list text-center"
				...
				<div class="input-group" style="margin: auto;">
					<input type="text" placeholder="Month *" id="month"
						...
						ng-model="timeperiod.timePeriod">
				</div>
			</div>
			<div class="text-center alreadySubmitted" ng-class="allIndicatorsModel.cssClass" ng-show="allIndicatorsModel.statusMessage != null">{{alreadySubmitted}}</div>
			...
			<div class="profile-entry">
				...
				<div id="profileTable" class="accordion-content expanded">	
						...
						<table items="tableData" show-filter="true" cellpadding="0"
							...
							<tbody >
								<tr>
									...
									<td class="inputBox"  >
										<input style="font-size: 18px;" hide-header-footer type='text' class='tableInput' ng-model="hasLR"
										ng-disabled="true">
									</td>
								</tr>
								<tr
					...
					<div class="text-center">
							...
							ng-disabled="!(enabled) || (!(profileTableData['35'][0].percentage 
							...
							ng-disabled="!(enabled) || (!(profileTableData['34'][0].percentage || profileTableData['35'][0].percentage || profileTableData['39'][0].percentage || profileTableData['40'][0].percentage || profileTableData['44'][0].percentage))"
								ng-click="confirmReset()">RESET</button>
						</div>	
				</div>		
		</div>	
		</section>
		<section ng-show="pageLoaded && (profileDataSaved || !(enabled))" class="formTable col-md-12 col-sm-12 col-xs-12">
...
<!-- 									<td >{{rowData['coreAreaName']}}</td> -->
						...
						<div class="text-center">
							<button class="submitSNCU" ng-disabled="!(enabled)"
	...
	<!-- popup modal -->
	<div id="addIndicatorSuccess" class="addIndicatorSuccess modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog">
			<!-- Modal content-->
			<div class="modal-content">
				<div class="modal-body text-center">
	...
	<script type="text/javascript"
		src="resources/js/angularController/sncuDataEntryController.js"></script>
	<script type="text/javascript">
