		...
		<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 40px;">
				<div class="terms-margin"><h3>Sitemap</h3></div>
					...
					<ul class="siteMapData">
						...
						<li><a href="home/#partner-sec">Partners</a></li>
						<li><a href="home/#contactUs-sec">Contact Us</a></li>
						<li>Login
										   <ul class="siteMapDate">
											<li>Data Entry</li>
											<ul class="siteMapDate">
											<li><a href="sncuDataEntry">SNCU/NICU</a></li>
											<li><a href="pdsa">PDSA</a></li>
											</ul>
											<li>Dashboard</li>
											<ul class="siteMapDate">
											<li><a href="dashboardHome">Home</a></li>
											<li><a href="dashboardFacilityView">Facility View</a></li>
											<li><a href="pdsaSummary">PDSA Summary</a></li>
											<li><a href="smallMultiple">Small Multiple</a></li>
											</ul>
