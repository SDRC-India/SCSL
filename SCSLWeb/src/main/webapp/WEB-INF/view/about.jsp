...
<jsp:include page="fragments/header.jsp"></jsp:include>
	...
	<div id="mymain" class="container">
		...
		<section class="partners-cube">
			<div class="row">
				<div class="col-md-4">
					<div class="cube">
						<div class="front-side">
							<img alt="" style="width: 100%" src="http://l.rgbimg.com/cache1uNHvM/users/x/xy/xymonau/600/o8NDN5q.jpg">
							<div class="front-content"><h3>Access Health International</h3></div>
						</div>
						<div class="back-side">
							<p>df;sdf sdflds'
							f sdf' lsd'
							;l dsf;sdlfsdlf'sdlfsdlf'
							 sdflsd'flsd'
							 flsdfl'sdf;
							 'sdf</p>
						</div>
